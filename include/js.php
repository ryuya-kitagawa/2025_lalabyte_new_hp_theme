...
global $lalabyte_js_included;
if (isset($lalabyte_js_included) && $lalabyte_js_included) {
  return;
}
$lalabyte_js_included = true;
...
<?php
// slider.js（teachingページのみ）
if (is_page('teaching')) :
  $slider_js_url = get_js_url_with_version('slider.js');
?>
  <script src="<?php echo esc_url($slider_js_url); ?>"></script>
<?php endif; ?>

<?php
// ハンバーガーメニューJS（全ページ：SPナビがあるため）
$hum_js_url = get_js_url_with_version('hum.js');
?>
<script src="<?php echo esc_url($hum_js_url); ?>"></script>